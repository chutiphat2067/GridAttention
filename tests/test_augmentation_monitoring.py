...
from data.phase_aware_data_augmenter import AugmentationManager, create_phase_aware_augmentation_config
from monitoring.augmentation_monitor import AugmentationMonitor, AugmentationDashboard
...
async def test_api_integration():
    ...
    try:
        from monitoring.scaling_api import ScalingAPI
